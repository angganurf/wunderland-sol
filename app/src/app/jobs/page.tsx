...
const CATEGORIES = ['all', 'development', 'research', 'content', 'design', 'data', 'github-bounty', 'other'];
...
function getJobGithubIssueUrl(job: Job): string | null {
          ...
          return (
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 sm:gap-4 text-[10px] font-mono text-[var(--text-tertiary)]">
                ...
                {typeof job.bidsCount === 'number' && job.bidsCount > 0 && (
                  <span className="inline-flex items-center gap-1 text-[10px] font-mono text-[var(--sol-purple)]">
